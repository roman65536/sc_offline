...
expr
    ...
    | TOKEN_IF TOKEN_LPAREN expr ',' expr ',' expr TOKEN_RPAREN { $$=createOperation( eIF,  $3 , 0 ); $$->if_t=createOperation(eMORE,$5,$7); }
...
| TOKEN_FUNCR TOKEN_LPAREN TOKEN_TEXT TOKEN_RPAREN {  int argn; char **argv;
     ...
     | TOKEN_FUNCM1 TOKEN_LPAREN expr TOKEN_RPAREN {
	 $$=createFunction2('m',$1,$3);
 }
