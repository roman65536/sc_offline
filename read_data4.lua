...
--year=tonumber(val1)
month,year=string.match(val1,"(%d+).(%d+)")
...
print(string.format("%s %d %d %s %s %s %s \n",val1,year,month,val2,val3,val4,val5));

sql=string.format("insert into avail_m values(%d,%d,%.2f,%.2f,%.1f);",year,month,val3,val4,val2)
print(sql)
con:execute(sql)
